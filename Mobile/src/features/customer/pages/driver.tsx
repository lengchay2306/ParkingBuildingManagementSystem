      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <ThemedText style={styles.eyebrow}>
            {t("Vai trò 03 - Tài xế", "Role 03 - Driver")}
          </ThemedText>
          <ThemedText style={styles.title}>
            {t("Phiên gửi xe di động", "Mobile session")}
          </ThemedText>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.activeCard}>
            ...
            <ThemedText style={styles.activeDetail}>
              {t("Phí dự kiến - $8.50", "Estimated fee - $8.50")}
            </ThemedText>
          ...
          <View style={styles.mapCard}>
            ...
            <View style={styles.mapPinRow}>
              ...
              <ThemedText style={styles.mapText}>
                {t("Lộ trình AI tới B2-047", "AI route to B2-047")}
              </ThemedText>
            </View>
            <ThemedText style={styles.mapDetail}>
              {t("Đi bộ 4 phút - Thang máy B", "4 min walk - Elevator B")}
            </ThemedText>
          </View>
        </View>
          ...
          <View style={styles.qrRow}>
            ...
            <View style={styles.qrText}>
              ...
              <ThemedText style={styles.cardDetail}>
                {t("Hiệu lực đến 22:00", "Valid until 22:00")}
              </ThemedText>
        ...
        <View style={styles.card}>
          <ThemedText style={styles.eyebrow}>
            {t("Chỗ trống thời gian thực", "Live availability")}
          </ThemedText>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeaderRow}>
            <ThemedText style={styles.cardTitle}>
              {t("Hóa đơn gần đây", "Recent invoices")}
            </ThemedText>
