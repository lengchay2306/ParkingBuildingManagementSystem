...
/** Digit positions in `##X-###.##` (0-based indices). */
...
/**
 * Pulls the first Vietnamese license plate from raw OCR text.
...
export function extractLicensePlateFromOcrText(text: string): string | null {
  ...
  // Join hyphen-separated fragments: "30A" + "123.45"
  ...
  // OCR often drops punctuation: "51A12345" → "51A-123.45"
