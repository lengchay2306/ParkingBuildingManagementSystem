      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <ThemedText style={styles.eyebrow}>
            {t("Vai trò 04 - Quản trị hệ thống", "Role 04 - System Administrator")}
          </ThemedText>
          ...
          <View style={styles.cardHeaderRow}>
            <View>
              <ThemedText style={styles.cardTitle}>
                {t("Tài khoản người dùng", "User accounts")}
              </ThemedText>
              <ThemedText style={styles.caption}>
                {t("248 hoạt động - 12 tạm khóa", "248 active - 12 suspended")}
              </ThemedText>
            </View>
        ...
        <View style={styles.card}>
          ...
          <ThemedText style={styles.caption}>
            {t("Quyền theo vai trò", "Permissions by role")}
          </ThemedText>
          <View style={styles.list}>
            {rbac.map(([perm, roles]) => (
        ...
        <View style={styles.card}>
          ...
          <ThemedText style={styles.caption}>
            {t("Điều phối ô và nhận diện biển số", "Slot routing and plate recognition")}
          </ThemedText>
          <View style={styles.list}>
        ...
        <View style={styles.card}>
          <ThemedText style={styles.cardTitle}>
            {t("Tòa nhà và khu vực", "Buildings and zones")}
          </ThemedText>
          <View style={styles.list}>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeaderRow}>
            <ThemedText style={styles.cardTitle}>
              {t("Tình trạng hệ thống", "System health")}
            </ThemedText>
