...
} from '@/roles/customer/reservations';
...
function isSlotBookable(slot: ParkingSlot, floor: ParkingFloor, vehicleType: string | null): boolean {
  ...
  return (
    <View style={styles.reservationCard}>
      ...
      <View style={styles.infoRow}>
        ...
        <ThemedText style={styles.infoValue}>{formatDateTime(reservation.expectedArrival)}</ThemedText>
      </View>
      <View style={styles.infoRow}>
        <ThemedText style={styles.infoLabel}>{t('Hết hạn giữ chỗ', 'Hold expires')}</ThemedText>
        <ThemedText style={styles.infoValue}>{formatDateTime(reservation.expiryAt)}</ThemedText>
      </View>
    </View>
  );
}
        ...
        >
          ...
          <View style={styles.modalSheet}>
            ...
            <ScrollView contentContainerStyle={styles.modalBody} keyboardShouldPersistTaps="handled">
              ...
              <ThemedText style={styles.modalHint}>
                {t('Dự kiến', 'Expected')}: {formatDateTime(buildExpectedArrival(arrivalMinutes))}
              </ThemedText>
