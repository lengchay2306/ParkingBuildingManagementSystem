...
const SHAPE_MORPH_MS = 2200;
const LOGO_SHAPE_SIZE = 52;
const LOGO_SHAPE_RADIUS = LOGO_SHAPE_SIZE / 2;
...
export default function SignPlatformScreen() {
  ...
  const shapeMorph = useRef(new Animated.Value(0)).current;
  ...
  useEffect(() => {
    const loop = Animated.loop(
      Animated.sequence([
        Animated.timing(shapeMorph, {
          toValue: 1,
          duration: SHAPE_MORPH_MS,
  ...
  const logoShapeRadius = shapeMorph.interpolate({
    inputRange: [0, 1],
    outputRange: [8, LOGO_SHAPE_RADIUS],
  });
            ...
            <View style={styles.main}>
              <View
                ...
                <View style={styles.branding}>
                  <View style={[styles.logoCircle, { borderColor: palette.logoBorder, backgroundColor: isDark ? '#0a0a0a' : '#fff' }]}>
                    <Animated.View
                      style={[
                        styles.logoShape,
                        {
                          backgroundColor: palette.logoFill,
...
const styles = StyleSheet.create({
  ...
  logoShape: {
    width: LOGO_SHAPE_SIZE,
    height: LOGO_SHAPE_SIZE,
  },
  brandText: {
    fontSize: 30,
    lineHeight: 34,
